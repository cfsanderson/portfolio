        ...
        <div className='blogposts'>
          <div>
            <article>
              ...
              <button><a className='keep-reading' href='https://medium.com/@cfsanderson/script-src-https-gist-github-com-cfsanderson-db861b186bfbb72e98f467ed20415e40-js-script-9329d14bfd58#.cc6nodbfl' target='_blank'>KEEP READING <i className='fa fa-medium' aria-hidden='true' /></a></button>
            </article>
          </div>
          <div>
            <article>
              ...
              <button><a className='keep-reading' href='https://medium.com/@cfsanderson/fizzbuzzed-why-javascript-43ad273aa989#.aeag0p9rj' target='_blank'>KEEP READING <i className='fa fa-medium' aria-hidden='true' /></a></button>
            </article>
          </div>
          <div>
            <article>
              ...
              <button><a className='keep-reading' href='https://medium.com/@cfsanderson/react-looking-forward-e1aba7829556#.3i7evdtne' target='_blank'>KEEP READING <i className='fa fa-medium' aria-hidden='true' /></a></button>
            </article>
          </div>
        </div>
      </div>

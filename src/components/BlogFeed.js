        ...
        <div className='blogposts'>
          ...
          <div>
            <article>
              ...
              <button><a className='keep-reading' href='https://medium.com/@cfsanderson/halfway-6e8f07356b5d#.pyfshmxq6' target='_blank'>KEEP READING <i className='fa fa-medium' aria-hidden='true' /></a></button>
            </article>
          </div>
        </div>
      </div>
